    ...
    private void connect() throws SQLException {
        try {
            ...
            throw new SQLException(
                    "SQLite JDBC driver puudub. Kontrolli, kas sqlite-jdbc-3.49.1.0.jar on projektis olemas ja dependencies alla lisatud.",
                    e
            );
        }
        ...
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                while (rs.next()) {
                    ...
                    LocalDateTime played = LocalDateTime.parse(
                            gameTime,
